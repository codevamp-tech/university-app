    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerRight}>
          ...
          <Image
            source={{ uri: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDkLv_4TT5iWRS7U2tDOQsNyHlYbfh4dGvbie0E0YDC7EZXGW3hqxO7SbwOS6OA0aAsq7xjaxf-xvBfEi8Z8cKbkiIhNvfKDgXPjANyUjX7wcgFnibmNayzwA_yEdSRVOEX9a098JWa8JUwF8YZTDDWNFahsIjm-dvntywxZv4yzj4Q7vut3mQqA7RKbZPUOIuEIZQVzZS8wtuWTxiB2GOEUeT43dCyBwxXJsoIBOiZvBNk7S2mwmqdWqfeRBl1lMo_yo2i_DPOdkfw' }}
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileSection}>
          ...
          <View style={styles.profileInfoWrap}>
            ...
            <Text style={styles.profileSub}>Batch of 2025 • Invertis University Bareilly</Text>
            <View style={styles.infoCapsuleRow}>
              ...
              <View style={styles.infoCapsule}>
                ...
                <Text style={styles.infoValue}>INV-2022-094</Text>
              </View>
              <View style={styles.infoCapsule}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.certsContainer}>
            <View style={styles.certCard}>
              <View style={styles.certImgBox}>
                <Image source={{ uri: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDeMp8KExPP-mtUke2kOSExXY2ZF0-KPSr4_BWISAEV96WQMjZ8c-gIN8N3MDVuNL3W9P2_QTb65_Gb1bjdLEqfql5syAODPJ8LX2PiNu4gT15Aa5_NiE57znpo1K5waCxyCC5oGtICTefR_R_YtqVaBM8u_bJp8nBmneBlPCkLW-FDAJEFU_VJrSE7KazdaU4cW2QJ7QRo-YUED9COkt-K6YA3QZrsOTsdzy4dr4_Pdh4gj6aVDhwuB7x3XKOzPxkBc24eqBNAMZnf' }} style={styles.certImg} />
              </View>
            ...
            <View style={styles.certCard}>
              <View style={styles.certImgBox}>
                <Image source={{ uri: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCFxNwf4tljvU2VUw0hoE1MaYbT7rBYyYSN8DZsmFulMlYTRxq9XVsza7Ng0S5c_JtrU4OCXX7gY6VAdV87Dv6_UqlY9sBl8Jm52Z3ZUo1YYjTmuQI1QcuyIlny77qhXJvJA7d5zsC1LOFO6kjBJh9cFwYrupFj-gtmeFEFxBMExwb6ClkG16Q9VR1PMBUuNrExWGoLA5l9Bt_TAu2QHprIfZzE9ogRIW4ekHFeA4-QW7rhISgJoqcnmcOeZ0Vn891YbiFqPciNPBct' }} style={styles.certImg} />
              </View>
